 ...
 */
export default function Typography({ children, font, color, decoration = false, textAlign = "left" }: TypographyProps) {
  return(
    <S.StyledText font={font} color={color} decoration={decoration} textAlign={textAlign}>{children}</S.StyledText>
  )
}